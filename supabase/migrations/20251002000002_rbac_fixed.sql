-- =====================================================
-- RBAC SETUP - FIXED VERSION
-- =====================================================
-- Fixes the foreign key constraint issue with owners table
-- =====================================================

-- =====================================================
-- STEP 1: ADD UNIQUE CONSTRAINT TO OWNERS.OWNER_ID
-- =====================================================
-- This is required before we can reference it as a foreign key

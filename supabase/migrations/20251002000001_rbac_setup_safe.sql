-- =====================================================
-- SAFE RBAC SETUP - Handles existing structures
-- =====================================================
-- This version safely handles if some structures already exist
-- =====================================================

-- =====================================================
-- STEP 1: CREATE USER ROLE ENUM (SAFE)
-- =====================================================
DO $$ 
BEGIN
...
-- =====================================================
-- Drop table if exists (WARNING: This will delete existing profile data)
...
-- Add foreign key for owner_id (after table creation)
...
-- =====================================================
-- STEP 7: CREATE RLS POLICIES FOR PROPERTIES
-- =====================================================
...
-- =====================================================
-- STEP 8: CREATE RLS POLICIES FOR OWNERS
-- =====================================================
...
-- =====================================================
-- STEP 9: CREATE RLS POLICIES FOR TAX_RECORDS
-- =====================================================
...
-- =====================================================
-- STEP 10: CREATE RLS POLICIES FOR PLANNING_DATA
-- =====================================================
